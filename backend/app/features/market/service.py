...
def fetch_exchange_rate(currency: str) -> str:
    ...
    """
    currency_map = {
        "USD": "0000001", "미국 달러": "0000001", "달러": "0000001", "미국달러": "0000001",
        "JPY": "0000002", "엔화": "0000002", "엔": "0000002",
        "EUR": "0000003", "유로": "0000003", "유로화": "0000003",
        "CNY": "0000053", "위안": "0000053", "위안화": "0000053", "중국 위안": "0000053", "중국위안": "0000053",
        "GBP": "0000012", "파운드": "0000012", "영국 파운드": "0000012", "영국파운드": "0000012",
        "CAD": "0000013", "캐나다 달러": "0000013", "캐나다달러": "0000013",
        "CHF": "0000014", "스위스 프랑": "0000014", "스위스프랑": "0000014",
        "HKD": "0000015", "홍콩 달러": "0000015", "홍콩달러": "0000015",
        "AUD": "0000017", "호주 달러": "0000017", "호주달러": "0000017",
        "NZD": "0000026", "뉴질랜드 달러": "0000026", "뉴질랜드달러": "0000026",
        "SGD": "0000024", "싱가포르 달러": "0000024", "싱가포르달러": "0000024",
        "TWD": "0000031", "대만 달러": "0000031", "대만달러": "0000031",
        "THB": "0000028", "태국 바트": "0000028", "태국바트": "0000028",
        "IDR": "0000029", "인도네시아 루피아": "0000029", "루피아": "0000029",
        "MYR": "0000025", "말레이시아 링깃": "0000025", "링깃": "0000025",
        "PHP": "0000034", "필리핀 페소": "0000034", "페소": "0000034",
        "VND": "0000035", "베트남 동": "0000035", "동": "0000035",
        "INR": "0000037", "인도 루피": "0000037", "루피": "0000037",
        "MXN": "0000040", "멕시코 페소": "0000040",
        "BRL": "0000041", "브라질 헤알": "0000041", "헤알": "0000041",
        "RUB": "0000043", "러시아 루블": "0000043", "루블": "0000043",
        "SAR": "0000020", "사우디 리얄": "0000020", "리얄": "0000020",
        "AED": "0000023", "아랍에미리트 디르함": "0000023", "디르함": "0000023",
        "TRY": "0000050", "터키 리라": "0000050", "튀르키예 리라": "0000050", "리라": "0000050",
        "ZAR": "0000051", "남아공 랜드": "0000051", "랜드": "0000051",
        "EGP": "0000052", "이집트 파운드": "0000052",
    }
        ...
        with httpx.Client(timeout=5.0) as client:
            ...
            if "StatisticSearch" in data and "row" in data["StatisticSearch"]:
                ...
                if rows:
                    ...
                    if currency_code in ["0000002", "0000006", "0000010", "0000029", "0000035"]:
                        return f"현재 {currency} 환율은 100단위당 {latest_rate}원 입니다."
    ...
    try:
        if country_lower in ["한국", "대한민국", "korea"]:
            ...
            country_map = {
                ...
                "폴란드": "PL", "poland": "PL",
                "러시아": "RU", "russia": "RU",
                "남아프리카공화국": "ZA", "남아공": "ZA", "south africa": "ZA",
                "스웨덴": "SE", "sweden": "SE",
                "스위스": "CH", "swiss": "CH", "switzerland": "CH",
                "튀르키예": "TR", "터키": "TR", "turkey": "TR",
            }

...
async def extract_voice_vector(filename: str, audio_bytes: bytes, content_type: str) -> list[float]:
    ...
    try:
        async with httpx.AsyncClient() as client:
            ...
            response = await client.post(f"{settings.ASV_SERVER_URL}/enroll", files=files, timeout=10.0)

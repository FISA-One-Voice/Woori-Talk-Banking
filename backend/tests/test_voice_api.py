...
class TestVoiceRegistration:
    ...
    def test_voice_register_extract_failed(self, mock_extract, client: TestClient, valid_token: str):
    ...
    @patch("app.features.voice.service.extract_voice_vector")
    def test_voice_register_service_unavailable(self, mock_extract, client: TestClient, valid_token: str):

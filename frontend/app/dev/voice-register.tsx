...
const styles = StyleSheet.create({
  ...
  infoBox: {
    backgroundColor: '#1C1C16', borderWidth: 1, borderColor: '#363628',
    borderRadius: 16, padding: 24, marginBottom: 40,
  },
  infoLabel: { color: '#A1A18A', fontSize: 14, fontWeight: '600', marginBottom: 8 },
  infoDesc: { color: COLORS.textMain, fontSize: 24, fontWeight: '700', lineHeight: 34 },
  listContainer: { gap: 20 },
  listItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1E1E1E', padding: 16, borderRadius: 12 },
  listNumber: { width: 24, height: 24, borderRadius: 12, backgroundColor: COLORS.highlightYellow, justifyContent: 'center', alignItems: 'center', marginRight: 16 },
  listNumberText: { color: '#000', fontWeight: 'bold', fontSize: 14 },
  listText: { color: COLORS.textMain, fontSize: 16, lineHeight: 22 },
  centerAction: { flex: 1, alignItems: 'center', justifyContent: 'center', marginBottom: 100 },
  micCircle: { width: 120, height: 120, borderRadius: 60, borderWidth: 2, borderColor: COLORS.highlightYellow, justifyContent: 'center', alignItems: 'center' },
  actionText: { color: COLORS.textMain, fontSize: 18, fontWeight: '500' },
  recordingBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1A331E', paddingVertical: 8, paddingHorizontal: 16, borderRadius: 20, marginBottom: 40 },
  recordingDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#4ADE80', marginRight: 8 },
  recordingBadgeText: { color: '#4ADE80', fontWeight: '600' },
  centerActionSuccess: { alignItems: 'center', marginTop: 40, marginBottom: 40 },
  checkCircleLine: { width: 100, height: 100, borderRadius: 50, borderWidth: 3, borderColor: '#4ADE80', justifyContent: 'center', alignItems: 'center', marginBottom: 16 },
  failCircleLine: { width: 100, height: 100, borderRadius: 50, borderWidth: 3, borderColor: '#F87171', justifyContent: 'center', alignItems: 'center', marginBottom: 16 },
  successTitleText: { color: COLORS.textMain, fontSize: 24, fontWeight: 'bold' },
  failTitleText: { color: '#F87171', fontSize: 24, fontWeight: 'bold' },
  button: { backgroundColor: COLORS.highlightYellow, width: '100%', paddingVertical: 20, borderRadius: LAYOUT.borderRadius, alignItems: 'center', marginBottom: 16 },
  buttonText: { fontSize: FONT_SIZES.button, color: COLORS.background, fontWeight: '700' },
});
